...
Renderer::Renderer(const std::size_t screen_width,
	...
	// Create Window
	sdl_window = SDL_CreateWindow("Asteroids          Score: ", SDL_WINDOWPOS_CENTERED,
...
void Renderer::UpdateWindowTitle(int score, int maxScore) {
	std::string title{ "Asteroids          Score: " + std::to_string(score) + "          High Score: " + std::to_string(maxScore) };
